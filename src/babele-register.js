...
Hooks.once("init", () => {
    if (game.babele) {
        game.settings.register("lang-pt-BR-pf2e", "dual-language-names", {
            ...
            hint: "Além do português, o inglês também é usado.",
            scope: "world",
            type: Boolean,
            default: false,
            config: true,
        ...
        game.babele.registerConverters({
            normalizeName: (_data, translation) => {
                return game.langPtPf2e.normalizeName(translation);
            },
            translateAdventureActorItems: (data, translation) => {
                return game.langPtPf2e.translateItems(data, translation, true, false);
            },
            translateActorDescription: (data, translation) => {
                return game.langPtPf2e.translateActorDescription(data, translation);
            },
            translateActorItems: (data, translation) => {
                return game.langPtPf2e.translateItems(data, translation, true);
            },
            translateAdventureActors: (data, translation) => {
                return game.langPtPf2e.translateArrayOfObjects(data, translation, "adventureActor");
            },
            translateAdventureItems: (data, translation) => {
                return game.langPtPf2e.translateItems(data, translation, false, false);
            },
            translateAdventureJournals: (data, translation) => {
                return game.langPtPf2e.translateArrayOfObjects(data, translation, "adventureJournal");
            },
            translateAdventureJournalPages: (data, translation) => {
                return game.langPtPf2e.translateArrayOfObjects(data, translation, "adventureJournalPage");
            },
            translateAdventureScenes: (data, translation) => {
                return game.langPtPf2e.translateArrayOfObjects(data, translation, "adventureScene");
            },
            translateDualLanguage: (data, translation) => {
                return game.langPtPf2e.translateDualLanguage(data, translation);
            },
            translateDuration: (data) => {
                return game.langPtPf2e.translateValue("duration", data);
            },
            translateHeightening: (data, translation) => {
                return game.langPtPf2e.dynamicObjectListMerge(
                    data,
                    translation,
                    game.langPtPf2e.getMapping("heightening", true)
                );
            },
            translateRange: (data) => {
                return game.langPtPf2e.translateValue("range", data);
            },
            translateRules: (data, translation) => {
                return game.langPtPf2e.translateRules(data, translation);
            },
            translateSkillSpecial: (data, translation) => {
                return game.langPtPf2e.dynamicArrayMerge(
                    data,
                    translation,
                    game.langPtPf2e.getMapping("skillSpecial", true)
                );
            },
            translateSource: (data) => {
                return game.langPtPf2e.translateValue("source", data);
            },
            translateSpellVariant: (data, translation) => {
                return game.langPtPf2e.dynamicObjectListMerge(
                    data,
                    translation,
                    game.langPtPf2e.getMapping("item", true)
                );
            },
            translateTiles: (data, translation) => {
                return game.langPtPf2e.dynamicArrayMerge(data, translation, game.langPtPf2e.getMapping("tile", true));
            },
            translateTime: (data) => {
                return game.langPtPf2e.translateValue("time", data);
            },
            translateTokens: (data, translation, _dataObject, _translatedCompendium) => {
                return game.langPtPf2e.translateArrayOfObjects(data, translation, "token");
            },
            translateTokenName: (data, translation, _dataObject, _translatedCompendium, translationObject) => {
                return game.langPtPf2e.translateTokenName(data, translation, translationObject);
            },
            updateActorImage: (data, _translations, dataObject, translatedCompendium) => {
                return game.langPtPf2e.updateImage("portrait", data, dataObject, translatedCompendium);
            },
            updateTokenImage: (data, _translations, dataObject, translatedCompendium) => {
                return game.langPtPf2e.updateImage("token", data, dataObject, translatedCompendium);
            },
        });
